<html>
  ...
  <body>
    ...
    mysqli_query($mysqli, "set session character_set_client=utf8;");
		...
		$sql = "UPADTE `user` SET name='$name', id='$id', email='$email_1@$email_2', phoneNumber='$phone_1-$phone_2-$phone_3', 					personNumber='$person_1-$person_2' WHERE id='$_SESSION[user_name]';";
    if($mysqli->query($sql)){
